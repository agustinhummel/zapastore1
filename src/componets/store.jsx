...
const store = () => {
  ...
  const pics = [
    ...
    "https://res.cloudinary.com/dc0rv28n2/image/upload/v1686921602/zapastore/IMG_0474_essvjv.jpg",
    ...
    "https://res.cloudinary.com/dc0rv28n2/image/upload/v1686921620/zapastore/IMG_0780.jpg_aicymj.jpg"
  ]
  ...
  <div class="container px-5 py-24 mx-auto flex flex-wrap">
    <div class="flex w-full mb-20 flex-wrap">
      <h1 class="sm:text-3xl text-2xl font-medium title-font text-white lg:w-max lg:mb-0 mb-4">Productos en stock</h1>
    ...
    <div class="flex flex-wrap md:-m-2 -m-1">
      ...
      <div class="flex flex-wrap w-1/2">
        ...
        <div class="md:p-2 p-1 w-1/2">
          <img alt="gallery" class="w-full object-cover h-full object-center block" src={pics[4]}/>
        </div>
      </div>
  </div>
